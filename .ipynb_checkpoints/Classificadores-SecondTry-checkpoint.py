...
# Crie o modelo base Random Forest
model = RandomForestClassifier(random_state=RANDOM_STATE)

# Crie um classificador baseado em GridSearchCV para otimizar hiperparâmetros
grid_search = GridSearchCV(model, param_grid, scoring='f1_weighted', cv=5)

# Realize a busca de hiperparâmetros e obtenha o melhor modelo com os melhores hiperparâmetros
